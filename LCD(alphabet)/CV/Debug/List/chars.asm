...
; .FSTART _main
; 0000 0024 
; 0000 0025     char alphabets[28] = {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x ...
; 0000 0026 
...
_0xD:
	CALL _lcd_gotoxy
; 0000 0032         }
; 0000 0033         lcd_putchar(alphabets[i]);
	MOVW R26,R28
	ADD  R26,R4
	ADC  R27,R5
	LD   R26,X
